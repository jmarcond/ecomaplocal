...
class Login
{
    ...
    public function __construct()
    {
        ...
        elseif (!empty($_SESSION['user_name']) && ($_SESSION['user_logged_in'] == true)) {
    ...
    private function loginWithPostData()
    {
        ...
        if (!empty($_POST['user_name']) && !empty($_POST['user_password'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $checklogin = $this->db_connection->query("SELECT user_id, user_name, user_email, user_password_hash FROM ".DB_USERS_TABLE." WHERE user_name = '" . $this->user_name . "';");
